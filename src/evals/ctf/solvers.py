"""
CTF solver implementations for the CyberAgentBreeder project.
"""
...
from evals.intercode_ctf import IntercodeCTF
...
def ctf_agent(max_attempts: int = 3, max_messages: int = 50) -> Solver:
    """Create a CTF agent solver.

    Args:
        max_attempts: Maximum number of attempts per task
        max_messages: Maximum number of messages per task
